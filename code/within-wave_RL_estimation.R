### RL Estimation & Choice Set Estimation
...
####################
#route data
route_file <- list.files(inputroutepath, pattern="wave1")
#link data
link_file <- list.files(inputlinkpath, pattern="wave1")

n_data <- length(route_file)
if (n_data!=length(link_file)){
  print("imcomplete dataset!!")
}
